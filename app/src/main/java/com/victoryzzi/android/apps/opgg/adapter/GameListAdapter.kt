...
import com.victoryzzi.android.apps.opgg.adapter.viewholder.GameListViewHolder
...
class GamesDiffCallBack : DiffUtil.ItemCallback<Game>() {
    override fun areItemsTheSame(oldItem: Game, newItem: Game): Boolean = oldItem.gameId == newItem.gameId

    override fun areContentsTheSame(oldItem: Game, newItem: Game): Boolean = oldItem.gameId == newItem.gameId
}